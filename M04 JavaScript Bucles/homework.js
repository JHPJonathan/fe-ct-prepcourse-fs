...
function fizzBuzz(num) {
   ...
   // Tu código:
   return num%3 === 0 && num%5 === 0 ? "fizzbuzz" : 3%num===0 ?"fizz":5%num===0?"buzzz": num;
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  return (num1 >0 &&num2 >0 && num3>0)?
    num1>num2 && num1>num3?
    "Numero 1 es mayor y positivo":num3>num2 && num3>num1? num3+1 :false : num1 ===0 ||num2 ===0 || num3===0?"Error" : "Hay negativos";
}
